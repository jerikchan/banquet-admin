...
export const getQudaoListByPage = (params?: DirectoryPageParams) =>
...
export const updateQudao = (params?: DirectoryParams) =>
  defHttp.post<DirectoryListGetResultModel>(
    {
...
export const setQudaoStatus = (id: number, status: string) =>
