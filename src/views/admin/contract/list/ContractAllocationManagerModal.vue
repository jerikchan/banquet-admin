...
<script lang="ts">
  ...
  import { managerAllocationSchema } from './contract.data';
  import { allocationManager } from '/@/api/admin/contract';

  export default defineComponent({
    name: 'ContractAllocationManagerModal',
    ...
    setup(_, { emit }) {
      ...
      const getTitle = computed(() => (!unref(isUpdate) ? '分配管家' : '分配管家'));
