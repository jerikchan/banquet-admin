<template>
  <PageWrapper title="员工详情" contentBackground @back="goBack">
    <!-- <template #extra>
    ...
    <template #footer>
      <a-tabs default-active-key="detail" v-model:activeKey="currentKey">
        <a-tab-pane key="detail" tab="员工资料" />
...
<script>
  ...
  import { findUserInfo } from '/@/api/admin/system';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(async () => {
        userInfo.value = await findUserInfo({ id: userId.value });
      });
