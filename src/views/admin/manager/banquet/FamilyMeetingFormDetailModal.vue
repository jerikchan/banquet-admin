...
<script lang="ts">
  ...
  import { getFamilyMeetingFormDetail, uploadFamilyMeetingForm } from '/@/api/admin/manager';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function handleData(id: string) {
        let res = await getFamilyMeetingFormDetail({ id: id });
        // mockData.agreementCode = res.agreementCode;
        // mockData.name = res.name;
        // mockData.finishTime = res.finishTime;
        // mockData.remark = res.remark;
        // mockData.agreementId = res.agreementId;
      ...
      function exportForm() {
        ...
        window.location.href =
          devUrl + '/file/downloadFamilyMeetingForm?agreementId=' + mockData.agreementId;
      }
