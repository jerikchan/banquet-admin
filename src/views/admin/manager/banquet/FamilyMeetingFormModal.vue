<template>
  <PageWrapper title="家庭沟通记录修改" contentBackground @back="goBack">
...
<script lang="ts">
  ...
  import { familyMeetingFormSchema } from './manager.data';
  import { getFamilyMeetingFormDetail, updateFamilyMeetingForm } from '/@/api/admin/manager';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [register, { setFieldsValue, getFieldsValue }] = useForm({
        ...
        schemas: familyMeetingFormSchema,
      ...
      async function submitAll() {
        try {
          ...
          await updateFamilyMeetingForm(submitValues);
      ...
      async function handleData(id: string) {
        res = await getFamilyMeetingFormDetail({ id: id });
        setFieldsValue({
          ...res,
        });
      }
