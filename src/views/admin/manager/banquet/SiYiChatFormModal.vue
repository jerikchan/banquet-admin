<template>
  <PageWrapper title="司仪沟通记录修改" contentBackground @back="goBack">
...
<script lang="ts">
  ...
  import { siYiChatFormSchema } from './manager.data';
  import { getSiYiChatFormDetail, updateSiYiChatForm } from '/@/api/admin/manager';
