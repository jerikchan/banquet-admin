<template>
  <PageWrapper title="客户跟进记录修改" contentBackground @back="goBack">
...
<script lang="ts">
  ...
  import { customerFollowFormSchema } from './manager.data';
  import { getCustomerFollowFormDetail, updateCustomerFollowForm } from '/@/api/admin/manager';
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const [register, { setFieldsValue, getFieldsValue }] = useForm({
        ...
        schemas: customerFollowFormSchema,
      ...
      async function submitAll() {
        try {
          ...
          await updateCustomerFollowForm(submitValues);
      ...
      async function handleData(id: string) {
        res = await getCustomerFollowFormDetail({ id: id });
        setFieldsValue({
          ...res,
        });
      }
